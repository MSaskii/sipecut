            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-6 col-7">
                            <input type="text" class="form-control" id="field_surat_cuti" readonly>
                            <a class="btn btn-info" id="surat_cuti" href="#" target="__blank">Lihat Berkas</a>
                        </div>
                    </div>
                    <br>
        ...
        <section id="cari">
            <div class="row match-height">
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>Kelola Data Cuti Pegawai</h3>
...
@push('js')
    ...
    <script>
        ...
        function tambah(data) {
            ...
            var url_suratcuti = url.replace(':file', suratcuti_id);
