            ...
            <div class="card-body">
                <div class="row">
                    @if (session()->has('sukses'))
                        <div class="col-md-12">
                            <center>
                                <h3>Pengajuan Berhasil Diajukan!</h3>
                            </center>
                            <center>
                                <h3>Nomor Id Pengajuan</h3>
                            </center>
                            <br>
                            <center>
                    ...
                    @else
                        <form action="/datacuti" method="post" class="col-md-14">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="textarea" class="form-control" name="unit_kerja"
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="text" class="form-control" name="ket_cuti"
                                        placeholder="Keterangan Cuti" required>
                                </div>
                            </div>
                            <div class="form-group row align-items-center">
                                <div class="col-lg-2 col-3">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="date" class="form-control" name="akhir_tgl"
                                        placeholder="Pilih Tanggal" required>
                                </div>
                            </div>
                            <div class="form-group row align-items-center">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="number" class="form-control" name="no_hp" placeholder="No Handphone"
                                        required>
                                </div>
                            </div>
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-9">
                                    <input type="file" name="blanko" class="form-control" accept="application/pdf"
                                        required>
                                </div>
                                <text>Silahkan Unduh blanko : <a
                                        href="https://docs.google.com/document/d/1hoa_gptjwR4dmjccBUd9ak_tLYExsYIO/edit?usp=sharing&ouid=111267113886573629488&rtpof=true&sd=true">Unduh
                                        Blanko</a></text>
                            </div>
                            <div class="form-group row align-items-center">
                                <div class="col-lg-2 col-3">
                            ...
                            <div class="form-group row align-items-center">
                                <div class="col-lg-2 col-3">
                                    <label class="col-form-label">Surat Permohonan<text
                            ...
                            <div class="form-group row align-items-center" id="pengantar_form">
                                <div class="col-lg-2 col-3">
                                    <label class="col-form-label">Surat Pengantar<text
                                            style="color: red">*</text></label>
                                </div>
                                <div class="col-lg-10 col-9">
    ...
    <script>
        ...
        function showPengantar(select) {
            if (select.value == "Pegawai Dinas") {
                ...
                $("#pengantar_form").hide();
                $("#pengantar_form").prop('required', false);
            } else {
                // document.getElementById('pengantar_form').style.display = "block";
                $("#pengantar_form").show();
                $("#pengantar_form").prop('required', true);
            }
        }
    </script>
